        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="settings.php"><i class="fa fa-dashboard"></i>Tablero de usuario</a>
                    </li>
            </div>
                ...
                <div class="col-md-12">
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==0 ) {
												echo"<tr class='gradeC'>
													...
													<td><button class='btn btn-primary btn' data-toggle='modal' data-target='#myModal'>Modificar </button></td>
													<td><a href=usersettingdel.php?eid=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Retirar</button></td>
												</tr>";
											}
											else {
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input name="newps"  class="form-control" placeholder="Ingrese una contraseña">
                                            </div>
                                        </div>
					...
					<?php
						if(isset($_POST['in']))
						{
							...
							$newsql ="INSERT INTO `login` (usuario, contra) values ('$newus','$newps')";
                        ...
                        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Cambiar el nombre de usuario y la contraseña</h4>
                                    </div>
                                    <form method="post">
                                    <div class="modal-body">
                                        <div class="form-group">
                                        <label>Cambie el nombre de usuario</label>
                                        <input name="usuario" value="<?php echo $us; ?>" class="form-control" placeholder="Enter User name">
                                        </div>
                                    </div>
                                    <div class="modal-body">
                                        <div class="form-group">
